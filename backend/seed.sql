...
(
  gen_random_uuid(), 'Bluecoats', 'Canton, OH', NULL, 'Canton, OH',
...
(
  gen_random_uuid(), 'Boston Crusaders', 'Boston, MA', NULL, 'Boston, MA',
...
(
  gen_random_uuid(), 'Santa Clara Vanguard', 'Santa Clara, CA', NULL, 'Santa Clara, CA',
...
(
  gen_random_uuid(), 'Carolina Crown', 'Fort Mill, SC', NULL, 'Fort Mill, SC',
...
(
  gen_random_uuid(), 'Phantom Regiment', 'Rockford, IL', NULL, 'Rockford, IL',
...
(
  gen_random_uuid(), 'The Mandarins', 'Sacramento, CA', NULL, 'Sacramento, CA',
...
(
  gen_random_uuid(), 'Blue Stars', 'La Crosse, WI', NULL, 'La Crosse, WI',
...
(
  gen_random_uuid(), 'The Cavaliers', 'Rosemont, IL', NULL, 'Rosemont, IL',
...
(
  gen_random_uuid(), 'Troopers', 'Casper, WY', NULL, 'Casper, WY',
...
(
  gen_random_uuid(), 'Colts', 'Dubuque, IA', NULL, 'Dubuque, IA',
  'http://www.colts.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Spirit of Atlanta', 'Atlanta, GA', NULL, 'Atlanta, GA',
...
(
  gen_random_uuid(), 'The Academy', 'Tempe, AZ', NULL, 'Tempe, AZ',
...
(
  gen_random_uuid(), 'Crossmen', 'San Antonio, TX', NULL, 'San Antonio, TX',
...
(
  gen_random_uuid(), 'Seattle Cascades', 'Seattle, WA', NULL, 'Seattle, WA',
...
(
  gen_random_uuid(), 'Gold', 'San Diego, CA', NULL, 'San Diego, CA',
...
(
  gen_random_uuid(), 'River City Rhythm', 'Anoka, MN', NULL, 'Anoka, MN',
...
(
  gen_random_uuid(), 'Raiders', 'Princeton, NJ', NULL, 'Princeton, NJ',
...
(
  gen_random_uuid(), 'Blue Devils B', 'Concord, CA', NULL, 'Concord, CA',
  'http://www.bluedevils.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Blue Devils C', 'Concord, CA', NULL, 'Concord, CA',
  'http://www.bluedevils.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Guardians', 'McKinney, TX', NULL, 'McKinney, TX',
