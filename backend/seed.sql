...
INSERT INTO corps (id, name, location, audition_date, audition_location, audition_locations, website_url, instruments, requirements, corps_class, created_at) VALUES
...
(
  gen_random_uuid(), 'The Mandarins', 'Sacramento, CA', NULL, 'Sacramento, CA; Dallas, TX; San Antonio, TX; Indianapolis, IN; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Gold', 'San Diego, CA', NULL, 'San Diego, CA; Arcadia, CA; Remote',
  NULL,
...
(
  gen_random_uuid(), 'The Battalion', 'Salt Lake City, UT', NULL, 'Salt Lake City, UT; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Columbians', 'Pasco, WA', NULL, 'Pasco, WA; Remote',
  NULL,
...
(
  gen_random_uuid(), 'River City Rhythm', 'Anoka, MN', NULL, 'Anoka, MN; Waseca, MN; Remote',
  NULL,
...
(
  gen_random_uuid(), '7th Regiment', 'New London, CT', NULL, 'New London, CT; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Raiders', 'Princeton, NJ', NULL, 'Princeton, NJ; Salem, NJ; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Colt Cadets', 'Dubuque, IA', NULL, 'Dubuque, IA; Remote',
  NULL,
  'http://www.colts.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Les Stentors', 'Sherbrooke, QC', NULL, 'Sherbrooke, QC; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Blue Devils B', 'Concord, CA', NULL, 'Concord, CA; Milpitas, CA; Westlake Village, CA; Pomona, CA; Remote',
  NULL,
  'http://www.bluedevils.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Blue Devils C', 'Concord, CA', NULL, 'Fairfield, CA; Concord, CA; Remote',
  NULL,
  'http://www.bluedevils.org',
  ARRAY['Trumpet', 'Mellophone', 'Baritone', 'Tuba', 'Snare', 'Tenor', 'Bass Drum', 'Front Ensemble', 'Color Guard'],
...
(
  gen_random_uuid(), 'Guardians', 'McKinney, TX', NULL, 'McKinney, TX; Dallas, TX; San Antonio, TX; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Golden Empire', 'Bakersfield, CA', NULL, 'Bakersfield, CA; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Impulse', 'Buena Park, CA', NULL, 'Buena Park, CA; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Heat Wave', 'Tampa, FL', NULL, 'Tampa, FL; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Gems', 'Boise, ID', NULL, 'Boise, ID; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Arsenal', 'El Paso, TX', NULL, 'El Paso, TX; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Eclipse', 'Indianapolis, IN', NULL, 'Indianapolis, IN; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Memphis Blues', 'Memphis, TN', NULL, 'Memphis, TN; Remote',
  NULL,
...
(
  gen_random_uuid(), 'Zephyrus', 'Tulsa, OK', NULL, 'Tulsa, OK; Remote',
  NULL,
